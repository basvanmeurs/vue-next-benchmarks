var Vue = (function (exports) {
  ...
  function triggerMultiEffects(depSets, debuggerEventExtraInfo) {
      const sets = depSets.filter((set) => !!set);
      if (sets.length > 1) {
  ...
  function concatSets(sets) {
      const all = [].concat(...sets.map((s) => [...s]));
  ...
  function triggerEffects(dep, debuggerEventExtraInfo) {
      const run = (effect) => {
          if ( effect.options.onTrigger) {
              effect.options.onTrigger(Object.assign({ effect }, debuggerEventExtraInfo));
          }
          if (effect.scheduler) {
  ...
  function trackRefValue(ref) {
      if (isTracking()) {
          ref = toRaw(ref);
          const eventInfo =  { target: ref, type: "get" /* GET */, key: 'value' } ;
          if (!ref.dep) {
              // This ref could be wrapped in a readonly proxy.
              ref.dep = new Set();
          }
  ...
  function triggerRefValue(ref, newVal) {
      ref = toRaw(ref);
      if (ref.dep) {
          const eventInfo =  { target: ref, type: "set" /* SET */, key: 'value', newValue: newVal } ;
  ...
  CustomRefImpl.prototype.__v_isRef = true;
  ...
  */
  ...
  function baseCreateRenderer(options, createHydrationFns) {
      ...
      const setupRenderEffect = (instance, initialVNode, container, anchor, parentSuspense, isSVG, optimized) => {
          ...
          }, queueJob, true, // #1801, #2043 component render effects should allow recursive updates
          false,  createDevEffectOptions(instance) );
      };
